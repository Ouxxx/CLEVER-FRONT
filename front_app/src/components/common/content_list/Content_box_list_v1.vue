...
<div class="content-list-root">
    ...
    <div class="content-list-main" :style="styleListContent">
        <div v-if="contentType == 'video'">
            <ch-box-video v-for="video in postedContent" :key="video.docId" 
                :docid="video.docId" :title="video.title" :author="video.author" :image="video.background" :categorie="video.categorie" :favorite="video.isFavorite" :width="contentWidth"
...
<script>
import chBoxVideo from '../../common/video/Video_box_v1'
import chEcrit from '../../common/ecrit/Ecrit_v1'

var list
export default {
    components : { chBoxVideo, chEcrit },
    props : {
        contents : Array,
        contentType : String
    },
    ...
    mounted () {
        ...
        else if(this.contentType == 'ecrit') this.minWidth = this.writingMinWidth
