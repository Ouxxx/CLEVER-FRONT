        ...
        <div class="profile-main">
            ...
            <div class="info-post-block">
                <div class="info-area">
                    ...
                    <div class="save-text">Voici mon super texte de présentation. Vraiment trop beau. Merci
                    </div>
...
export default {
    components : {banner, postOne, chPicker,chMosaique},
    data () {
        return  {
            videos : [
                {
